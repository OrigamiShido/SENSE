...
enum I2cControllerStatus gI2cControllerStatus;
...
//    DL_I2C_flushControllerTXFIFO(I2C_0_INST);
    ...
    DL_I2C_startControllerTransfer(I2C_0_INST, I2C_TARGET_ADDRESS, DL_I2C_CONTROLLER_DIRECTION_TX, count+1);
...
void I2C_ReadReg(uint8_t reg_addr, uint8_t *reg_data, uint8_t count)
{
    ...
    DL_I2C_startControllerTransfer(I2C_0_INST, I2C_TARGET_ADDRESS, DL_I2C_CONTROLLER_DIRECTION_TX, 1);
    ...
    DL_I2C_startControllerTransfer(I2C_0_INST, I2C_TARGET_ADDRESS,DL_I2C_CONTROLLER_DIRECTION_RX, count);
